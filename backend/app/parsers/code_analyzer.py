...
class PythonCodeAnalyzer:
                ...
                if isinstance(node, ast.FunctionDef):
                    ...
                    for item in node.body:
                        if isinstance(item, ast.FunctionDef):
                            method_entity = self._analyze_method(item, node.name, str(file_path))
    ...
    def _analyze_method(self, node: ast.FunctionDef, class_name: str, file_path: str) -> CodeEntity:
...
class JavaScriptCodeAnalyzer:
    ...
    def _extract_functions(self, content: str, lines: List[str], file_path: str) -> List[CodeEntity]:
    ...
    def _extract_classes(self, content: str, lines: List[str], file_path: str) -> List[CodeEntity]:
